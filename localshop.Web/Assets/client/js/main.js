(function ($) {
    ...
    win.on('scroll', function () {
        ...
        if (scroll < 200) {
            ...
            $(document).trigger('stickRemove');
        } else {
            header.addClass('stick');
            $(document).trigger('stickAdd');
        }
    });
...
function custom() {
    ...
    $(document).ready(function () {
        $(document).on('stickAdd', function () {
            ...
            $('.stick-main').removeClass('col-md-12').addClass('col-xl-8 col-lg-7');
        });

        $(document).on('stickRemove', function () {
            $('.stick-active').removeClass('d-block').addClass('d-none');
